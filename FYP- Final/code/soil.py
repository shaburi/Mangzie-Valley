...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.frames = import_folder(f'../graphics/plants/{plant_type}')
        self.soil = soil
        ...
        # sign
        self.sign_image = pygame.image.load(f'../graphics/sign/{plant_type}.png')
        # resizing it to be the same size as the other sprites
        self.sign_image = pygame.transform.scale_by(self.sign_image, 4)
    ...
    def draw_sign(self, surface, rect):

        offset_rect = rect.copy()
        offset_rect.centery -= TILE_SIZE
        surface.blit(self.sign_image, offset_rect)
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):
        ...
        self.hoe_sound.set_volume(0.1 * VOLUME)

        self.plant_sound = pygame.mixer.Sound('../audio/plant.wav')
        self.plant_sound.set_volume(0.2 * VOLUME)
